...
<!-- Title -->
<div class="title">
  <h2>MAT-450: Advanced Linear Algebra</h2>
</div>
...
<div style="width: 100%">
  ...
  <div class="list">
    <ul>
      <li><strong>Time: </strong> T, R 12:15 - 1:30 pm</li>
      <li><strong>Place: </strong> CHAM 2234</li>
      <li><strong>Important Dates</strong>
      <hr class="hrstyle-two" style="width: 25%">
        <ul>
          <li><strong>Review 1: </strong>February 12 - 16</li>
		  <li><strong>Review 2: </strong>March 15 - 20</li>
  ...
  <div class="schedule-container">
    ...
    <div class="mySlides fade">
      ...
      <tr>
        <td>Spring Break</td><td>Spring Break</td>
      </tr>
      </table>
    </div>
    <!-- Week 9 -->
    ...
    <div class="mySlides fade">
      ...
      <tr>
        <td>Matrix Polynomials<br>Generalizatio of Jordan chains</td><td>Matrix Polynomials<br>Spectral bounds of Unitary Matrix Polynomials<br><strong><a href="homework/homework6.pdf" target="_blank">Homework 6: Due 4/20</a></strong></td>
      </tr>
      </table>
    </div>
    <!-- Week 15 -->
    <div class="mySlides fade">
      ...
      <tr>
        <td>Spring Convocation</td><td>Research Day</td>
      </tr>
      </table>
    </div>
    <!-- Week 16 -->
